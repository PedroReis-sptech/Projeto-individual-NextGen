...
-- ============================================================
-- NextGen · Dados de exemplo para popular o banco
-- Execute este arquivo no seu banco de dados MySQL (nextgen)
-- ============================================================
...
-- ------------------------------------------------------------
-- USUÁRIOS
-- Tipo 'time' = administrador do sistema
-- Tipo 'aluno' = atleta que se inscreve nas peneiras
-- Tipo 'professor' = avaliador/técnico
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- PENEIRAS (12 peneiras distribuídas por clube e categoria)
-- fk_criador = 1 (Admin) para todas
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- INSCRIÇÕES (distribuídas entre atletas e peneiras)
-- Status: pendente, aprovado, reprovado
-- ------------------------------------------------------------
INSERT INTO inscricao (fk_atleta, fk_peneira, status) VALUES
  -- Pedro Reis (aluno id=4) em 3 peneiras
  (4,  1, 'aprovado'),
  (4,  2, 'pendente'),
  (4,  6, 'pendente'),
...
-- ------------------------------------------------------------
-- TREINOS (últimas 12 semanas para o aluno Pedro Reis - id=4)
-- e para alguns outros alunos (para os gráficos funcionarem)
-- ------------------------------------------------------------

-- Pedro Reis (id=4) - 12 semanas, ~3x por semana
INSERT INTO treino (fk_atleta, data_treino, presente) VALUES
  (4,'2026-03-03',1),(4,'2026-03-05',1),(4,'2026-03-07',0),
  (4,'2026-03-10',1),(4,'2026-03-12',1),(4,'2026-03-14',1),
  (4,'2026-03-17',0),(4,'2026-03-19',1),(4,'2026-03-21',1),
  (4,'2026-03-24',1),(4,'2026-03-26',1),(4,'2026-03-28',1),
  (4,'2026-03-31',1),(4,'2026-04-02',0),(4,'2026-04-04',1),
  (4,'2026-04-07',1),(4,'2026-04-09',1),(4,'2026-04-11',1),
  (4,'2026-04-14',0),(4,'2026-04-16',1),(4,'2026-04-18',1),
  (4,'2026-04-21',1),(4,'2026-04-23',1),(4,'2026-04-25',1),
  (4,'2026-04-28',1),(4,'2026-04-30',0),(4,'2026-05-02',1),
  (4,'2026-05-05',1),(4,'2026-05-07',1),(4,'2026-05-09',1),
  (4,'2026-05-12',0),(4,'2026-05-14',1),(4,'2026-05-16',1),
  (4,'2026-05-19',1),(4,'2026-05-21',1),(4,'2026-05-23',1);

-- Gabriel Silva (id=7)
INSERT INTO treino (fk_atleta, data_treino, presente) VALUES
  (7,'2026-04-01',1),(7,'2026-04-03',1),(7,'2026-04-05',1),
  (7,'2026-04-08',0),(7,'2026-04-10',1),(7,'2026-04-12',1),
  (7,'2026-04-15',1),(7,'2026-04-17',0),(7,'2026-04-19',1),
  (7,'2026-04-22',1),(7,'2026-04-24',1),(7,'2026-04-26',0);

-- Lucas Oliveira (id=5)
INSERT INTO treino (fk_atleta, data_treino, presente) VALUES
  (5,'2026-04-01',1),(5,'2026-04-03',0),(5,'2026-04-05',1),
  (5,'2026-04-08',1),(5,'2026-04-10',1),(5,'2026-04-12',1),
  (5,'2026-04-15',1),(5,'2026-04-17',1),(5,'2026-04-19',0),
  (5,'2026-04-22',1),(5,'2026-04-24',1),(5,'2026-04-26',1);

-- Matheus Costa (id=8)
INSERT INTO treino (fk_atleta, data_treino, presente) VALUES
  (8,'2026-04-01',0),(8,'2026-04-03',1),(8,'2026-04-05',1),
  (8,'2026-04-08',1),(8,'2026-04-10',0),(8,'2026-04-12',1),
  (8,'2026-04-15',1),(8,'2026-04-17',1),(8,'2026-04-19',1),
  (8,'2026-04-22',0),(8,'2026-04-24',1),(8,'2026-04-26',1);
